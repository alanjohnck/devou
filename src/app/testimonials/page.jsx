    ...
    <section className="relative py-20 overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-64 h-64 opacity-10">
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <path fill="#gray-700" d="M46.5,-57.5C60.5,-45.5,72.3,-30.7,75.8,-14C79.3,2.7,74.5,21.1,64.9,35.8C55.2,50.5,40.8,61.4,24.9,66.9C9.1,72.4,-8.2,72.6,-21.8,65.9C-35.4,59.3,-45.4,45.9,-55.3,31.6C-65.3,17.3,-75.2,2.2,-74.6,-13.1C-73.9,-28.3,-62.7,-43.6,-48.5,-55.6C-34.4,-67.6,-17.2,-76.3,-0.3,-75.9C16.5,-75.6,32.5,-69.4,46.5,-57.5Z" transform="translate(100 100)" />
          </svg>
        </div>
        <div className="absolute bottom-0 right-0 w-96 h-96 opacity-10">
          <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
            <path fill="#gray-700" d="M35.9,-47.8C45.5,-35.3,51.5,-22.8,56.7,-7.9C61.8,7,66.2,24.3,59.8,35.9C53.4,47.5,36.3,53.3,19.5,58.6C2.8,64,-13.5,69,-25.9,64.1C-38.3,59.3,-46.7,44.6,-53.3,29.9C-59.8,15.3,-64.5,0.8,-62.1,-12.3C-59.7,-25.4,-50.3,-37.2,-38.8,-49.1C-27.3,-61.1,-13.7,-73.2,-0.1,-73.1C13.5,-72.9,26.3,-60.4,35.9,-47.8Z" transform="translate(100 100)" />
          </svg>
        </div>
        {/* Light grid pattern */}
        <div className="absolute inset-0 bg-grid-gray/[0.03]"></div>
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative bg-gradient-to-br from-gray-900 to-black rounded-2xl shadow-lg p-8 md:p-12">
            {/* Quote icon */}
            <Quote 
              size={64} 
              className="absolute text-gray-600 top-8 left-8 opacity-30" 
            />
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
              <div className="md:w-1/3 flex justify-center">
                <motion.div
                  ...
                  className="rounded-full overflow-hidden w-48 h-48 border-4 border-gray-700 shadow-lg"
                >
                  <img 
            ...
            <div className="absolute bottom-8 right-8 flex gap-2">
              <button 
                ...
                className="p-2 rounded-full bg-gray-800 shadow hover:bg-gray-700 transition duration-200"
