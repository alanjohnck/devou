      ...
      <div className="container mx-auto px-6 h-auto"> 
        <div className="flex flex-col lg:flex-row items-center gap-12"> 
          ...
          <div className="lg:w-1/2 relative">
            <div className="rounded-xl overflow-hidden shadow-xl relative group">
              ...
              */}
              ...
              <div className="absolute inset-0 bg-gradient-to-tr from-gray-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
              
              {/* Optional play button styling if you want to add it later */}
              <div className="absolute bottom-4 right-4 bg-gray-800/90 p-2 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          ...
          <div className="lg:w-1/2"> 
            <div className="inline-flex items-center px-3 py-1 rounded-full bg-slate-100 text-sm font-medium text-slate-800 mb-6"> 
              <span className="flex h-2 w-2 rounded-full bg-slate-600 mr-2"></span> 
              About Devou 
            </div> 
             
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">We turn complex ideas into elegant digital solutions</h2> 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8"> 
              <div className="flex items-start"> 
                ...
                <div> 
                  <h3 className="font-semibold text-slate-900 mb-2">Experienced Team</h3> 
                  <p className="text-slate-600 text-sm">Top talent from diverse tech backgrounds</p> 
                </div> 
              </div> 
              ...
              <div className="flex items-start"> 
                ...
                <div> 
                  <h3 className="font-semibold text-slate-900 mb-2">Agile Process</h3> 
                  <p className="text-slate-600 text-sm">Rapid iteration with continuous feedback</p> 
                </div> 
              </div> 
              ...
              <div className="flex items-start"> 
                ...
                <div> 
                  ...
                  <p className="text-slate-600 text-sm">Serving clients across 15+ countries</p> 
                </div> 
              </div> 
              ...
              <div className="flex items-start"> 
                ...
                <div> 
                  <h3 className="font-semibold text-slate-900 mb-2">Future-Proof</h3> 
                  <p className="text-slate-600 text-sm">Building with scalability in mind</p> 
                </div> 
              </div> 
            </div> 
          </div> 
